...
As a result, we obtain dE(s,t)=mins',t'dH(s',t'), where the
minimum is taken over all alignments of s and t. Strings s'
and t' achieving this minimum correspond to an optimal
alignment with respect to edit alignment score.

Given: Two protein strings s and t in FASTA format, each of
length at most 1000 aa.

Return: The total number of optimal alignments of s and t
with respect to edit alignment score, modulo 134,217,727
(2**27-1).
============================================================
'''
